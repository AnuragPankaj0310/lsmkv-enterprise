...
@click.argument("name")
@click.pass_context
def snapshot_create(ctx, name: str):
    """Create a snapshot."""
    ...
    async def _do():
        ...
        try:
            await client.snapshot_create(name)
...
def snapshot_list(ctx):
    ...
    async def _do():
        ...
        try:
            snapshots = await client.snapshot_list()
...
@click.argument("name")
@click.pass_context
def snapshot_restore(ctx, name: str):
    """Restore a snapshot."""
    ...
    async def _do():
        ...
        try:
            await client.snapshot_restore(name)
...
@click.argument("name")
@click.pass_context
def snapshot_info(ctx, name: str):
    ...
    async def _do():
        ...
        try:
            info = await client.snapshot_info(name)
...
@click.argument("name")
@click.pass_context
def snapshot_delete(ctx, name: str):
    """Delete a snapshot."""
    ...
    async def _do():
        ...
        try:
            await client.snapshot_delete(name)
